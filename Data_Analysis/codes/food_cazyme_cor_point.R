...
#Grain_mixtures_frozen_plate_meals_soups_GH24
plot1 <- subset(selected_plot,selected_plot$food=='Grain_mixtures_frozen_plate_meals_soups')
plot1 <- filter(plot1,plot1$cazyme=='GH24')
...
g
ggsave("./result/linear_plots/Grain_mixtures_frozen_plate_meals_soups_GH24.pdf",
       width = 5,height = 5)

#Citrus_fruits_juices_GH125
plot2 <- subset(selected_plot,selected_plot$food=='Citrus_fruits_juices')
plot2 <- filter(plot2,plot2$cazyme=='GH125')
...
g <- ggplot(plot2,aes(x=weight,y=count))+geom_point(aes(fill=UserName),alpha=0.5,size=4,shape=21)+
  ...
  ylab('GH24') + xlab("Grain mixtures frozen plate meals soups")
g
ggsave("./result/linear_plots/Citrus_fruits_juices_GH125.pdf",
       width = 5,height = 5)


#Meatpoultry_fish_with_nonmeat_CBM61
plot3 <- subset(selected_plot,selected_plot$food=='Meatpoultry_fish_with_nonmeat')
plot3 <- filter(plot3,plot3$cazyme=='CBM61')
...
g
ggsave("./result/linear_plots/Meatpoultry_fish_with_nonmeat_CBM61.pdf",
       width = 5,height = 5)

#Deepyellow_vegetables_CBM66
plot4 <- subset(selected_plot,selected_plot$food=='Deepyellow_vegetables')
plot4 <- filter(plot4,plot4$cazyme=='CBM66')
...
g
ggsave("./result/linear_plots/Deepyellow_vegetables_CBM66.pdf",
       width = 5,height = 5)

#Deepyellow_vegetables_GH5
plot5 <- subset(selected_plot,selected_plot$food=='Deepyellow_vegetables')
plot5 <- filter(plot5,plot5$cazyme=='GH5')
...
g
ggsave("./result/linear_plots/Deepyellow_vegetables_GH5.pdf",
       width = 5,height = 5)

#Citrus_fruits_juices_CBM22
plot6 <- subset(selected_plot,selected_plot$food=='Citrus_fruits_juices')
plot6 <- filter(plot6,plot6$cazyme=='CBM22')
...
g
ggsave("./result/linear_plots/Citrus_fruits_juices_CBM22.pdf",
       width = 5,height = 5)
